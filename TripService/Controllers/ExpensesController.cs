...
namespace TripService.Controllers
{
    ...
    public class ExpensesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(int tripId, [FromBody] ExpenseCreateDto dto)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int tripId, int id, [FromBody] ExpenseUpdateDto dto)
        {
            try
            {
